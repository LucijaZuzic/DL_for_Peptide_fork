...
workbook = Workbook('xlsx_version_no_val_merged/joined_all.xlsx')
mini = 3
maxi = 24
if not os.path.isdir('xlsx_version_no_val_merged/'):
    os.makedirs('xlsx_version_no_val_merged/')
for model_name in model_list:
    workbook_model = Workbook('xlsx_version_no_val_merged/joined_all_' + model_name + '.xlsx')
